  ...
  methods: {
    ...
    async getCast() {
      ...
      const result = await axios.get(
        `https://api.themoviedb.org/3/tv/${vm.data.id}/credits?api_key=0f79586eb9d92afa2b7266f7928b055c`
      );
    ...
    async getReview() {
      const vm = this;
      const result = await axios.get(
        `https://api.themoviedb.org/3/tv/${vm.data.id}/reviews?api_key=0f79586eb9d92afa2b7266f7928b055c`
      );
